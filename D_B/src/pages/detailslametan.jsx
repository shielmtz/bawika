...
import detailselametan from "../assets/selametan.png";
    ...
    <>
      ...
      <main className="bg-[#fdfcf0] min-h-screen px-4 py-6">
        ...
        <section className="text-center mt-6">
          <h1 className="text-3xl font-bold text-gray-800">Selametan</h1>
          <div className="mt-4">
            <img
              src={detailselametan}
              alt="Selametan"
...
export default DetailSelametan;
